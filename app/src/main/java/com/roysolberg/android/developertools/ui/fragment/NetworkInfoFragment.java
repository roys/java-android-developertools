...
public class NetworkInfoFragment extends Fragment {
    ...
    private final static String TAG = NetworkInfoFragment.class.getSimpleName();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.item_collapse:
                ...
                getFragmentManager().beginTransaction().replace(layoutIdToReplace, new NetworkInfoFragment()).commit();
                return true;
    ...
    protected void sendConfiguration(String configuration) {
        ...
        sendIntent.putExtra(Intent.EXTRA_SUBJECT, ("Resource qualifiers collected by Developer Tools " + Utils.getVersion(getContext())));
        sendIntent.putExtra(Intent.EXTRA_TEXT, configuration);
        try {
